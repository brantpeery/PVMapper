...
(function (INLModules) {
    ...
    var OpenStreetMapSocialModule = (function () {
        function OpenStreetMapSocialModule() {
            var myModule = new pvMapper.Module({
                ...
                scoringTools: [
                    ...
                    //},
                    {
                        ...
                        scoreUtilityOptions: {
                            functionName: "linear3pt",
                            functionArgs: new pvMapper.ThreePointUtilityArgs(0, 0.4, 30, 0.8, 100, 1, "% in favor","Proximity Aceptance","Preference","Preference for percentage of respondents regard to historical landmarks.")
                        },
                        weight: 10
                    },
                    {
        ...
        return OpenStreetMapSocialModule;
    })();

    var modinstance = new OpenStreetMapSocialModule();
