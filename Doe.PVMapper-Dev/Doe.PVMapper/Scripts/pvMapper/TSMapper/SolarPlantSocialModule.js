...
(function (INLModules) {
    ...
    var SolarPlantSocialModule = (function () {
    ...
    function addAllMaps() {
        mapLayer = new OpenLayers.Layer.ArcGIS93Rest("Existing Solar Plants", snlLineExportUrl, {
            layers: "show:0",
            format: "gif",
            srs: "3857",
            transparent: "true"
    ...
    function updateScoreFromSNL(score) {
    ...
    function updateScoreFromCache(score) {
        ...
        if (closestFeature !== null) {
            ...
            var nearestPlantStr = closestFeature.attributes.Power_Plant ? " (The nearest plant, " + closestFeature.attributes.Power_Plant + ", is " + minDistanceStr + " mi away" : " (The nearest plant is " + minDistanceStr + " mi away";
            ...
            score.popupMessage = percentOk.toFixed(1) + "% of respondents reported they would accept a site built " + distanceOkStr + " mi or more from an existing solar plant. (There was no existing solar plant found within the " + configProperties.maxSearchDistanceInMI + " mi search distance.)";
