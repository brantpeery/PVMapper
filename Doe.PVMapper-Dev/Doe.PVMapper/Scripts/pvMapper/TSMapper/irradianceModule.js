                ...
                scoringTools: [
                    {
                        ...
                        scoreUtilityOptions: {
                            functionName: "linear",
                            functionArgs: new pvMapper.MinMaxUtilityArgs(0, 8, //override the default for specific message.
                            "Minimum Direct-Normal Irradiation allowed.", "Maximum Direct-Normal Irradiation allowed.")
                        },
                        defaultWeight: 10
                    }, 
                    {
