...
(function (pvMapper) {
    ...
    */
    ...
    Ext.define('MyApp.data.ScoreModel', {
        ...
        idProperty: 'Score_ID',
        belongsTo: //create an associate table between Site and Tool.
        [
            'MyApp.data.ToolModel', 
            {
                model: 'SiteModel',
                associationKey: 'site_score'
            }
        ]
    });
    //============== Project Info ===============
