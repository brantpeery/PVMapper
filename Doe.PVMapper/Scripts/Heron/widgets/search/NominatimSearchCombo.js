 ...
 */
Ext.define('Heron.widgets.search.NominatimSearchCombo', {
    extend: 'Ext.form.ComboBox',
    alias: 'widget.hr_nominatimsearchcombo',
     ...
     */
    emptyText: 'Search for address or place name',
