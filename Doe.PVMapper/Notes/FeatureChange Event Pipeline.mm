...
<node CREATED="1347864574740" ID="ID_985978966" MODIFIED="1361220860912" STYLE="fork" TEXT="ScoreLine.onSiteChangeHandler(event)">
...
<node CREATED="1347864805163" ID="ID_660774975" MODIFIED="1361220870152" STYLE="fork" TEXT="Updates the Score on this ScoreLine using the parameter Score">
